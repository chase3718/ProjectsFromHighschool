...
public class TeletextList
{
  ...
  {
    heading = new listNode2("Todays Headlines",null,null);
    heading.setNext(heading);
    heading.setPrevious(heading);
    this.addBefore(heading,"");
    this.addAfter(heading,"");

    for (String msg : headlines) {
    	nodeAfter = addAfter(nodeAfter, msg);
    }
  }
  ...
  {
    ListNode2 newNode = new ListNode2(msg, node.getNext(), node);
